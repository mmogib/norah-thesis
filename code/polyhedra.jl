...
# ╔═╡ e5b9fb46-8fe1-11ec-1a17-e9982923df44
using Polyhedra, CDDLib

# ╔═╡ 4a09415a-f6c9-449f-ab66-12217e7792c3
begin
	hr = HalfSpace([-0.5, -0.5], -0.2929) ∩ HalfSpace([-1, 0], 0) ∩ HalfSpace([0, -1], 0)
	polyf = polyhedron(hr, CDDLib.Library())
	vr = vrep(polyf)
	hrmath =  MixedMatVRep(vr)
	hrmath.V
end
	

# ╔═╡ b0f4024f-24d4-4c3b-b6d4-37c9498360bf
